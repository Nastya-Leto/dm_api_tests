...
class TestActivationUser:
    ...
    def test_successful_activation_user(self, account_helper_f, prepare_user):
    ...
    def test_unsuccessful_activation_user(self, account_helper_f, prepare_user):
        ...
        response = account_helper_f.activation_user(token)
