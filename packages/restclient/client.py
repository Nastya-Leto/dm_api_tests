...
from packages.restclient.utilies import allure_attach


class RestClient:
    def __init__(self, configuration:Configuration, headers=None, ):
    ...
    def _send_request(self, method, path, **kwargs):
        log = self.log.bind(evend_id=str(uuid.uuid4()))
